...
namespace MusicStore
{
    public class StartupSocialTesting
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //ChangedForNosDb
            services.AddDbContext<MusicStoreContext>(options => options.UseNosDb(Configuration["Data:DefaultConnection:ConnectionString"]));

            //services.AddIdentity<ApplicationUser, IdentityRole>()
            //    .AddUserStore<MusicStoreContext>()
            //    .AddDefaultTokenProviders();

            //}

            // Add Identity services to the services container
            services.AddIdentity<ApplicationUser, Models.IdentityRole>(options =>
                    {
