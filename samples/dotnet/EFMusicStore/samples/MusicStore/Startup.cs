    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddIdentity<ApplicationUser, IdentityRole<string>>()
                .AddEntityFrameworkStores<MusicStoreContext, string>()
                .AddDefaultTokenProviders();
            services.AddDbContext<MusicStoreContext>(options => options.UseNosDb(Configuration[StoreConfig.ConnectionStringKey.Replace("__", ":")]));
